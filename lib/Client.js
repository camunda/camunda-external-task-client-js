...
const VariableService = require('./__internal/VariableService');
...
class Client extends events {
  ...
  subscribe(topic, customOptions, handler) {
    ...
    const topicSubscription = { handler, unsubscribe, lockDuration, ...customOptions };
  ...
  executeTask(task) {
    ...
    const variables = new VariableService(task.variables, true);
