...
// Variables
const WRONG_TYPED_FORMAT = (key) => `Couldn't set variable ${key}, wrong typed value format.`;
const UNSUPPORTED_VARIABLE_TYPE = (key) => `Couldn't set variable ${key}, unsupported variable type.`;
