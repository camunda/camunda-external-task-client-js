...
const ALREADY_REGISTERED = 'Couldn\'t subscribe worker, since it\'s already registered for this topic';
const MISSING_HANDLER = 'Couldn\'t subscribe worker, missing handler function';
